(ns vega-vis.stocks-index-chart)
  ...
  :axes [
   ...
   :marks [{:type "group"
            ...
            :marks [{:type "line"
                    ...
                    {:type "text"
                     :from {:data "label"}
                     :encode {:update {:x {:scale "x" :field "date" :offset 2}
                                       :y {:scale "y", :field "indexed_price"}
           ...
           {:type "rule"
            :encode {:update {:x {:scale "x" :signal "indexDate" :offset 0.5}
                              :y {:value 0}
                              :y2 {:field {:group "height"}}
                              :stroke {:value "firebrick"} }}}
      {:type "text"
       :encode {:update {:x {:scale "x", :signal "indexDate"}
